...
We appreciate many things about our investor: Bloomberg is a different kind of company. Bloomberg is a pioneer -- it created one of the original SaaS businesses, the first professional social network, and invented many practices that are now widely adopted by startups. Mike Bloomberg takes his profits and invests them in philanthropy. We hope startups will be inspired by Bloomberg’s example, as we are – and we want founders to know that returns they generate for Bloomberg Beta will go toward good in the world.

Bloomberg knows and respects technology and technology companies, is set up to be independent-minded, and builds toward long-term value. Bloomberg was created more than four decades ago on a then-controversial idea — that information in financial markets should be more widely available. Bloomberg has reached global scale and influence, with more than 21,000 employees in almost 200 locations — and yet it is still a private company, held by its founders.
...
Once upon a time, technology startups only made hardware and software — today they often build entirely new services and products, with technology at their core. One of the most important new kinds of startups is a ["hot-swap" startup](https://also.roybahat.com/looking-for-more-of-a-new-kind-of-startup-516e5033c63c), which directly replaces some enormous incumbent by using technology to compete with it directly. Today, startups are entering enormous, traditional industries — like [logistics](https://www.flexport.com/), [insurance](https://www.newfront.com/), [construction](https://www.buildtrayd.com/), [education](https://campus.edu/), [healthcare](https://tembo.health/), [software development](https://www.repl.it) and more — bringing a wildly better offering than the established old guard. 
...
We believe that work will continue to catch up and we’ll return to the historical norm, where technology arrives at work before it arrives at home. Work — especially knowledge work — will be the soil in which many of the [most exciting new technologies](https://www.yurts.ai/) will find their most interesting applications. Technology for work will write the first draft of technology history.

The impact of COVID, starting in 2020 forced companies to experiment with a more fluid workplace. Employers will expand benefits to include more support around mental health, child and elder care, and peer learning. Billion-dollar companies are built with employees spread throughout the world, without one “headquarters." New service providers support these hybrid, ever-changing workplaces — [collaboration](https://gatheround.com) [tools](https://wrangle.io), [people management](http://donut.com), [legal services](https://www.joinajax.com/), [publishing](https://binderybooks.com/), cloud infrastructure, cybersecurity, benefits, and more. 

#### Sudden shocks of technological change, driven by machine intelligence
We believe technology's pace, while accelerating, will affect us in a more profound way: changes, when they happen, will be far more sudden and jarring. The transition from a human society of hunters and gatherers to an agrarian one took about 3,000 years; the transition from agriculture to industry took roughly 300; industry to services took about 30. Whatever comes next will happen during the span of the careers of people working today. Now, an entire industry or category-leading company can fall off a cliff. In 1958, if a company cracked the S&P 500, it could expect to stay for 61 years — today, the expectation is [only 18 years](https://www.imd.org/research-knowledge/disruption/articles/why-you-will-probably-live-longer-than-most-big-companies/#:~:text=A%20recent%20study%20by%20McKinsey,S%26P%20500%20will%20have%20disappeared.).

Artificial intelligence, which we previously called [machine intelligence](https://medium.com/@shivon/the-current-state-of-machine-intelligence-f76c20db2fe1), in particular, crosses all the areas we care about, and we were [the first fund](https://techcrunch.com/2015/11/26/machine-intelligence-in-the-real-world/) to declare it as a focus area. We believe artificial intelligence will transform every industry and every function — and we focus on its effects on business. We believe [artificial intelligence will be like electricity](https://www.wired.com/2014/10/future-of-artificial-intelligence/): cheap, convenient, and on-demand.
...
We believe more work in the future will look like that of software developers today (automating away tasks and harnessing the [flexible](https://lambda.ai/) [power](http://graphistry.com/) of computers to get [work](https://alation.com/) done), and of securities traders (acting on quantitative [data](https://www.withprotege.ai/) all day long). We believe much individual work will be done in collaboration with software that makes its own choices. As a result, many people will suffer the [maker vs. manager](http://www.paulgraham.com/makersschedule.html) dilemma that today afflicts mostly software engineers. These individuals will [bring] [their](https://developer.apple.com/xcode-cloud/) [own](https://influxdata.com/) [tools](https://www.dataset.com/) (more than just their devices) to work, insisting on the [software](https://www.replit.com/) and [practices](https://launchdarkly.com/) that make them most productive.

#### The new company wo/man
Careers will look less like a straight line, and more like a [portfolio](https://www.airspace-intelligence.com/) of [activities](https://gigster.com/), with people judged on their work and their [capacities](https://replit.com/) as opposed to their past institutional affiliations (whether educational or professional). In some cases, people will decouple income from work, and integrate their lives and their work in ways considered career limiting today. Their personal, economic, social, geographic, and demographic backgrounds will also be much more diverse than the most recognized talents of today.

In particular, [the emergence of later-in-life new careers will be a social and economic phenomenon](https://medium.com/@Karin/who-wants-to-have-50-jobs-in-one-lifetime-how-to-keep-your-good-talent-b2ee023637a0). As people remain healthy and active later into life, they will contribute to workplaces and industries in ways that are hard for previous generations to imagine. [Startups that employ these older communities will thrive](https://also.roybahat.com/who-will-find-the-first-silver-unicorn-59bb40c75b09?gi=e73d09be98eb).
...
We are committed to [making the startup world welcoming](https://www.inclusionintech.com/) to people of all backgrounds, from our own team, to the founding teams we serve and the companies they build. Startups start with seeing the world anew, and people with different backgrounds see the world differently — so if we want to make things differently, we need to enlist people with as wide a range of backgrounds as possible. We seek to back founders [capable of building an inclusive culture](https://github.com/Bloomberg-Beta/Manual/blob/main/3%20-%20Criteria%20for%20investing.md#founders-and-team-2) where everyone can offer their best ideas and make the work extraordinary. We believe inclusivity creates excellence.

To raise our odds of seeing the strongest founders, our sourcing outreach includes founders from underrepresented communities. We define underrepresentation broadly, including but not being limited to ideological diversity, gender, race, ethnicity, sexual orientation, age, socioeconomic class, geography, nationality, education, and others.

We are proud of the inclusiveness of our team, though we can always do better. We believe groupthink is dangerous in venture capital, and that different perspectives make us more effective. 

We want to do better at backing founders from underrepresented backgrounds, because we believe there are exceptional individuals who likely have the skills to build a company without the network or personal financial means to get started. We want to back those individuals. For example, in the last two years, 26% of the startups we’ve backed have a female founder, 15% of all founders we’ve backed are women, and 24% of the CEOs we’ve backed are women. We would like to accurately track other demographic groups, though we avoid asking our founders to submit any mandatory data to us. 
...
We believe we need to hold ourselves accountable. As one measure, if a founder ever has an issue with our fund or our team, that founder can make a report to a Bloomberg representative, Deb Barker — dbarker67@bloomberg.net. We are accountable to our source of capital, and we follow [Bloomberg's policies](https://assets.bbhub.io/company/sites/51/2024/04/Bloomberg-Impact-Report-2023.pdf) — which cover our interactions with our customers (i.e., founders).

We strive to support the founders we back in building those healthy cultures. We refer candidates (including [board members](https://site.theboardlist.com/)) from all backgrounds, including underrepresented backgrounds. We ask founders if they're doing the work to [educate themselves](https://www.linkedin.com/video/live/urn:li:ugcPost:6803067615850962944/). We host "Turpentine Talks" (our roughly-monthly founder-to-founder tactical learning events for our portfolio) on the subject of building an inclusive team.

We believe a community of companies is stronger the more different viewpoints come to the table. As a fund and as individuals, we intend to work to create a more inclusive technology industry and do our part in fighting racism. For many of us on our team, this is core to how we see the world.
...
We mainly invest in the San Francisco Bay Area and New York, though we'll consider backing founders anywhere in North America. Our roots run deep in the Bay Area and New York, where we can best discover founders, attract local experts who can help, and build community among founders. We only want to invest when we believe we can be disproportionately helpful. (We once believed we could only serve founders effectively if we were local to them; we've changed our minds. We now believe we can effectively serve founders anywhere in North America.)

The world has changed: greatness can start anywhere. We recognize that founders anywhere can learn the tradecraft of building startups. Startups depend on trust, and while that once required spending time together in person, we’ve learned ways to build trust and deepen relationships virtually and have invested without meeting founders in person.

In some places founders still struggle to access follow-on capital, customers, and even talent (especially for startups doing something more difficult with a distributed workforce, like robotics). So the bar for what it takes to succeed may differ from place to place.

We've widened our own networks by spending time in cities we find promising. Toronto was one of the first cities where we spent time. One of the ways we’ve widened our own networks is by leading several tours to newer startup markets (aka our ["Comeback Cities" tours](https://www.nytimes.com/2018/03/04/technology/silicon-valley-midwest.html)). We, along with members of Congress and our VC friends visited cities from Atlanta to Youngstown to learn what it takes to invest there. We've made investments in DC, Toronto, Vancouver, Philadelphia, Los Angeles, Boston, Seattle, Austin, Miami, and Columbus, among others.
...
Also, we are most likely to invest in companies that come to us through someone we trust. Several of those have come our way through referrals from the staff at Bloomberg -- this creates an instant “customer reference,” often from someone whose judgment we respect.
...
### “Seed”
Our preference is to be the first money into a company, and to contribute a meaningful amount of capital. This is the core of what we do, and it reflects roughly 90% of the dollars we invest. We want to be able to add capital, sometimes even increasing our ownership stake, as the company evolves. While we lack a specific ownership percentage target, we try to get meaningful ownership given the stage of the company -- in practice, this can be 5-15% depending on how far the company’s progressed. It’s difficult to generalize because, in startups, exceptions are the rule. For these investments, for the sake of [transparency and simplicity](https://github.com/Bloomberg-Beta/Investment-Documents), we typically recommend an equity investment (as opposed to, for example, a SAFE), although we’re happy to use whichever investment type the founders prefer.
...
Our Open Angels include [Ivan Kirigin](https://www.linkedin.com/in/kirigin/), [Max Simkoff](https://www.linkedin.com/in/maxsimkoff/), [Lukas Biewald](https://www.linkedin.com/in/lbiewald/), [Jim Greer](https://www.linkedin.com/in/jimgreer/), [Michael Wellman](https://www.linkedin.com/in/mwellman/), [Dennis Pilarinos](https://www.linkedin.com/in/dennispi/), [Edith Harbaugh](https://www.linkedin.com/in/edithharbaugh/), [Travis Deyle](https://www.linkedin.com/in/travis-deyle-6951441b/), [Amjad Masad](https://www.linkedin.com/in/amjadmasad/), [Harry Campbell](https://www.linkedin.com/in/harrygcampbell/), [Raphael Parker](https://www.linkedin.com/in/raphaelparker/), [Nick Arner](https://www.linkedin.com/in/nickarner/), [Harshita Arora](https://www.linkedin.com/in/harshita-arora11/), and [David Rogier](https://www.linkedin.com/in/drogier/).

### “Funds”
While funds are a different business than startups, they're surprisingly similar: both have founders trying to find product-market fit and seek an outlier result. So, we invest in founders of funds when we believe they can produce an extraordinary return -- and we look to invest in the firm itself (either in the GP or the management company) so we can earn returns over the life of the firm, as opposed to just in their first batch of companies. Since we always invest as early as possible, we prefer first-time funds and  we avoid playing any role in deciding which companies the fund backs.
...
We also know startups are not all roses and sunshine, even for the best of companies. We aspire to be most helpful to you when times are tough. That’s why we’re committed to the mental wellbeing of all our founders, and why we'll always urge you to prioritize your mental health. We support founders treating the direct costs of caring for their mental well-being – including out-of-pocket expenses for therapy, coaching, group support, and software-based solutions – as a legitimate, worthwhile, and encouraged business expense. And for those needing the additional support, we can share a list of providers who provide coaching, therapy, and other services (like [Pilea](https://joinpilea.com/)) with you. 
...
We invite founders to many events. We believe one way we can help companies is just by getting them out of the building. We get our founders together every so often with an extended group of our friends, and with each other. Once founders start to see familiar faces, they understand that we're building a community of mutual support. These events are completely optional, and sometimes have no direct usefulness at all (like our old monthly game of [Werewolf](https://en.wikipedia.org/wiki/Mafia_(party_game)) in San Francisco).
...
Capital that we earn will go back to Bloomberg L.P., and therefore to [Bloomberg Philanthropies](https://www.bloomberg.org/), through Mike Bloomberg's personal giving, where they focus on five key areas for creating lasting change: the arts, education, the environment, government innovation, and public health.
